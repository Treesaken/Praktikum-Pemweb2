...
<div class="container px-5 my-5">
    <form id="contactForm" action="daftar_mahasiswa.php" method="POST">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" id="prodi" type="text" placeholder="Prodi" data-sb-validations="required" />
        ...
        <div class="mb-3">
            ...
            <input class="form-control" id="tahunAngkatan" type="text" placeholder="Tahun Angkatan" data-sb-validations="required" />
        ...
        <div class="mb-3">
            ...
            <input class="form-control" id="ipk" type="text" placeholder="IPK" data-sb-validations="required" />
